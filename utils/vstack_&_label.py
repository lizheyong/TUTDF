...
water = np.load(fr"C:\Users\zheyong\Desktop\高光谱目标检测报告\石测试\{this}\水100x100\{this}_water.npy")[:,9:129]
target = np.load(fr"C:\Users\zheyong\Desktop\高光谱目标检测报告\石测试\{this}\合成数据\{this}_no_synthetic_data.npy")

# water = np.tile(water, (2,1))
...
np.save(fr"C:\Users\zheyong\Desktop\高光谱目标检测报告\石测试\{this}\训练\{this}_train.npy", train_data)
np.save(fr"C:\Users\zheyong\Desktop\高光谱目标检测报告\石测试\{this}\训练\{this}_train_label.npy", train_label)
