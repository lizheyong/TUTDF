...
def train_net(net0, net1, net2, train_dataset, device, batch_size, lr, epochs):
    ...
    for epoch in range(epochs):
        ...
        net1.load_state_dict(torch.load(r'D:/LiZheyong/resnet/model/Backbone.pth'))
        ...
        for curve, label in train_loader:
            ...
            if loss < best_loss:
                best_loss = loss
                torch.save(net2.state_dict(), f'D:/LiZheyong/resnet/model/DenseB.pth')
            # 更新参数
            loss.backward()
            optimizer2.step()
            # i += 1
...
if __name__ == "__main__":
    ...
    # 加载域B的训练集
    dataset = train_Loader(r"C:\Users\423\Desktop\MLT\train_domain_2.npy",
                         r"C:\Users\423\Desktop\MLT\train_domain_2_label.npy")

    train_net(net0=Head, net1=Backbone, net2= DenseB, train_dataset=dataset, device=device,
              batch_size=32, lr=0.00001, epochs=50)
